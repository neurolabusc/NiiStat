function [acc, z_map, acc_per_class] = nii_stat_svm_core (xlsname, thresholdLo, thresholdHi, make_map, verbose)
...
% make_map  : generate weighting map
...
if ~exist('make_map','var') %make_map
    make_map=false;
end
